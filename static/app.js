...
if (shell) {
  ...
  // Persisted state. Clamp on read, not just on write: a stored
  // out-of-range value (old app version, touch-drag mishap) otherwise
  // renders a docked sidebar as an unusable sliver down the left edge.
  let sidebarWidth = parseInt(localStorage.getItem("sidebar-width") || SIDEBAR_DEFAULT_WIDTH, 10);
  if (!Number.isFinite(sidebarWidth)) sidebarWidth = SIDEBAR_DEFAULT_WIDTH;
  ...
  function buildSidebarDropSnippet(droppedPath) {
    ...
    const isImage = ["png", "jpg", "jpeg", "gif", "webp", "svg", "bmp", "avif", "excalidraw"].includes(ext);

    if (!isImage) {
      // Non-images: plain markdown link to wherever the file lives
  ...
  const TRANSLATIONS = {
    pl: {
      ...
      code_theme_default: "Default (jasny)", code_theme_eclipse: "Eclipse (jasny)", code_theme_idea: "IntelliJ IDEA (jasny)",
    ...
    en: {
      ...
      code_theme_default: "Default (light)", code_theme_eclipse: "Eclipse (light)", code_theme_idea: "IntelliJ IDEA (light)",
    ...
    es: {
      ...
      code_theme_default: "Default (claro)", code_theme_eclipse: "Eclipse (claro)", code_theme_idea: "IntelliJ IDEA (claro)",
    ...
    de: {
      ...
      code_theme_default: "Default (hell)", code_theme_eclipse: "Eclipse (hell)", code_theme_idea: "IntelliJ IDEA (hell)",
    ...
    ru: {
      ...
      code_theme_default: "Default (светлая)", code_theme_eclipse: "Eclipse (светлая)", code_theme_idea: "IntelliJ IDEA (светлая)",
  ...
  function openSettingsModal() {
    ...
    const lastTab = localStorage.getItem("settings-active-tab") || "source";
    setActiveSettingsTab(lastTab);
  }
  ...
  // Settings tab switching — vertical sidebar inside the settings modal.
  ...
  function setActiveSettingsTab(name) {
    ...
    try {
      localStorage.setItem("settings-active-tab", name);
    } catch {}
  }
