...
| Markdown files: "Code" view (CodeMirror with markdown syntax highlighting) as fourth mode in the dropdown | ✅ e2e `test_board_renders_columns_cards_and_subtask_thread` (menu assertions) | `plain_mode` label "Kod/Code"; save path reads from the active view |
