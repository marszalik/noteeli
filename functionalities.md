...
| Per-file view memory — last picked view restored on reopen (beats frontmatter detection; pruned to 200 entries) | ✅ e2e `test_mode_toggle_converts_plain_note_to_board` (pusta.md reopen) | `localStorage["noteeli-file-view-modes"]` |
