...
| Markdown files: plain-text view (CodeMirror) as fourth mode in the toggle cycle | ✅ e2e `test_board_renders_columns_cards_and_subtask_thread` (cycle assertions) | `plain_mode`; save path reads from the active view |
