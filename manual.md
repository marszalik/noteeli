...
with five views of the same note: **WYSIWYG**, **Markdown** (source view),
**Kanban** (board, see below), **Text** (bare plain-text editor) and
**Code** (CodeMirror with Markdown syntax highlighting). Noteeli
remembers the view you last used for each note and reopens it there.
All views edit the same plain `.md` file — there is no proprietary
format underneath.
